...
public class Entropy_Main {
	...
	public static void main( String [] args ) throws IOException
	{
		...
		//CsvWriter writer = new CsvWriter("calgary.csv");
	...
	public static void printToFile(File file, CsvWriter out) throws IOException
	{	
		try 
		{
			...
			out.write(((int)size)+ "" + ", " + m_Entropy + "");
			
			System.out.println("Your entropy for this particular files is --> " + size + ", " + m_Entropy);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
